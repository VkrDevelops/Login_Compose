        ...
        trailingIcon = {
            IconButton(onClick = {
                ...
                val visibleIconAndText = Pair(
                    first = R.drawable.ic_show_pas,
                    second = stringResource(id = R.string.password_visible)
                )

                val hiddenIconAndText = Pair(
                    first = R.drawable.ic_hide_pas,
                    second = stringResource(id = R.string.password_hidden)
                )
                ...
                Icon(
                    painter = painterResource(id = passwordVisibilityIconAndText.first),
